...
`NA` in a model marks a variable the solver left unassigned because
either polarity extends the model.
...
and raises a catchable R error; the solver handle stays usable
afterwards.
